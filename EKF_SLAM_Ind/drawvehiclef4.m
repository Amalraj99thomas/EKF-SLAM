...
%         vehicle_handle = drawFunction(x,y,psi,[]);
        ...
        axis([-15 15 -15 15]);
        hold on 
        ln_states1 = plot(lny1, lnx1, 'o', 'MarkerFaceColor', 'g');
        hold on 
        ln_states2 = plot(lny2, lnx2, 'o', 'MarkerFaceColor', 'g');
        hold on
        ln_states3 = plot(lny3, lnx3, 'o', 'MarkerFaceColor', 'g');
        hold on
        ...
        est_states = plot(pe_est, pn_est, 'bo','MarkerSize',20);
        hold on
